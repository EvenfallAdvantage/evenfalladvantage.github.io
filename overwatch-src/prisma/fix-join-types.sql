-- ============================================================
-- FIX: join_company_by_code — TEXT[] type mismatch
-- Run in: Supabase Dashboard → SQL Editor → New Query
-- 
-- Bug: work_preferences and notification_days were cast as jsonb
-- but the actual columns are TEXT[]. This caused:
--   "column work_preferences is of type text[] but expression is of type jsonb"
-- ============================================================
