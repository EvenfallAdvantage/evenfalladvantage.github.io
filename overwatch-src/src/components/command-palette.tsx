...
const ALL_ITEMS: PaletteItem[] = [
  ...
  { title: "Incidents", href: "/incidents", icon: "AlertTriangle", section: "Field Ops" },
  ...
  { title: "Training", href: "/training", icon: "GraduationCap", section: "Readiness" },
  { title: "Drills", href: "/quizzes", icon: "Target", section: "Readiness" },
  { title: "Scenarios", href: "/training/scenarios", icon: "MessageCircle", section: "Readiness" },
  ...
  { title: "Instructor", href: "/instructor", icon: "Video", section: "Readiness" },
  ...
  { title: "HQ Config", href: "/admin/settings", icon: "Settings", section: "Command" },
