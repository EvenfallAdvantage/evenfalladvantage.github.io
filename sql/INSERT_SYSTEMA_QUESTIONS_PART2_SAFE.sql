-- =====================================================
-- INSERT SYSTEMA SCOUT ASSESSMENT QUESTIONS - PART 2 (SAFE)
-- =====================================================
-- Modules 3, 4, and 5 (60 questions total)
-- This version checks for existing questions before inserting
-- =====================================================
...
BEGIN
    ...
    IF v_existing_count > 0 THEN
        RAISE NOTICE 'Module 3 already has % questions, skipping...', v_existing_count;
    ELSE
...
BEGIN
    ...
    IF v_existing_count > 0 THEN
        RAISE NOTICE 'Module 4 already has % questions, skipping...', v_existing_count;
    ELSE
        INSERT INTO assessment_questions (assessment_id, question_number, question_text, option_a, option_b, option_c, option_d, correct_answer) VALUES
...
BEGIN
    ...
    IF v_existing_count > 0 THEN
        RAISE NOTICE 'Module 5 already has % questions, skipping...', v_existing_count;
    ELSE
        INSERT INTO assessment_questions (assessment_id, question_number, question_text, option_a, option_b, option_c, option_d, correct_answer) VALUES
...
DO $$
BEGIN
    RAISE NOTICE 'Script completed! Checking final counts...';
END $$;
